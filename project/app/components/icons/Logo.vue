...
<template>
  <div class="rounded-full bg-primary p-2">
    <svg viewBox="0 0 122.88 120.68" class="size-6">
      <defs>
        <linearGradient id="logo-gradient" x1="100%" y1="0%" x2="0%" y2="0%">
          <stop offset="0%" style="stop-color: #44bcff" />
          <stop offset="50%" style="stop-color: #ff44ec" />
          <stop offset="100%" style="stop-color: #ff675e" />
        </linearGradient>
      </defs>
      <path
